...
using WebAppMovieTheatreAdmin.Models;

namespace Task2WebApp.Controllers
{
    public class CategoriesController : Controller
    {
        private readonly WebAppMovieTheatreAdminContext _context;

        public CategoriesController(WebAppMovieTheatreAdminContext context)
        {
            _context = context;
        }
